...
const DEFAULT_HEAD = [<meta key={-1} charSet="utf-8" className="zefir-head" />]
...
export class Head extends Component {
  ...
  updateElements(type, components) {
    ...
    const oldTags = Array.prototype.slice.call(
      headEl.querySelectorAll(type + '.zefir-head')
    )
  ...
  render() {
    const head = React.Children
      ...
      .reverse()
      .map((c: any) => {
        const className = (c.className ? c.className + ' ' : '') + 'zefir-head'
